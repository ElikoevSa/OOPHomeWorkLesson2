package ru.elikoev.classes.drugstore.pharmacys;

import ru.elikoev.classes.drugstore.components.Component;
import ru.elikoev.classes.drugstore.interfaces.SortByTotalWeight;

import java.util.*;


public class Pharmacy implements Iterator<Component>, Comparable<Pharmacy>, SortByTotalWeight {
